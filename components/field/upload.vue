<template>
	<field :name="name" v-slot="{ handleChange, handleBlur, meta }">
		<div class="flex items-center justify-center w-full">
			<label for="dropzone-file" :class="meta.touched && !meta.valid ? ' text-[#B92538] border-[#B92538]' : meta.valid ? ' border-green-700 text-green-700' : ' border-gray-300 text-gray-400'" class="flex flex-col items-center justify-center w-full border-2 border-dashed rounded-lg cursor-pointer h-fit bg-gray-50">
