        ...
        <div :class="!Installed ? 'h-full' : 'h-[95%]'"
            ...
            <div class=" w-full h-fit mt-6 md:my-10 xl:mt-20 md:w-[89.2%]  ">
                <h1 v-if="data?.statusCode != 200 || error"
                    class="text-[1.5em] select-none  text-black dark:text-white font-extrabold -mb-1 ">Curriculum Vitae</h1>
                <div v-if="data?.statusCode != 401 && !error">
                    <div class=" -mb-3 select-none  xl:-mb-2 hidden md:flex items-center justify-between">
                        ...
                        <a href="https://www.linkedin.com/in/roland-meijer-07bb97198/" target="_blank" class="px-4 py-2 dark:hover:bg-white dark:hover:ring-white  font-semibold dark:text-neutral-800 dark:bg-white dark:ring-white text-sm text-white bg-neutral-800 hover:bg-neutral-900 ring-2 hover:ring-neutral-900 ring-neutral-800 rounded-md">
                    ...
                    <div v-auto-animate :class="!hidecard1 ? 'h-[27.7vh] md:h-[31vh] xl:h-[29vh]' : 'h-fit'"
                        ...
                        <div class="flex select-none  items-center justify-between ">
                            ...
                            <div class="flex items-center gap-5 ">
                                ...
                                <button class=" md:hidden" @click="hidecard1 == false ? hidecard1 = true : hidecard1 = false">
                        ...
                        <div v-if="!hidecard1"
                            ...
                            <div class="flex p-2 bg-white dark:bg-neutral-900 rounded-lg snap-start">
                                <div class="w-full ">
                                    <div class="flex items-center gap-2 ">
                                        <Icon class="text-[#7D82AD] select-none " name="mdi:clock-time-seven" size="1.4em">
                                        </Icon>
                            ...
                            <div class="flex p-2 bg-white dark:bg-neutral-900 rounded-lg snap-start">
                                <div class="w-full ">
                                    <div class="flex items-center gap-2 ">
                                        <Icon class="text-[#7DADAC] select-none " name="material-symbols-light:check-circle"
                                            size="1.4em"></Icon>
                    ...
                    <div class=" md:grid grid-cols-2 gap-4 md:mt-2 select-text">
                        <div v-auto-animate class=" p-2 bg-[#F7F7F7] dark:bg-[#111111] rounded-lg mt-2 overflow-auto ">
                            <div class="flex items-center justify-between">
                                ...
                                <button class=" md:hidden" @click="hidecard2 == false ? hidecard2 = true : hidecard2 = false">
                                    <Icon name="ic:baseline-keyboard-arrow-down" size="1.4em"></Icon>
                                </button>
                            </div>
                            <div v-if="hidecard2"
                        ...
                        <div v-auto-animate class=" p-2 bg-[#F7F7F7] dark:bg-[#111111] rounded-lg mt-2 overflow-auto ">
                            <div class="flex items-center justify-between ">
                                ...
                                <button class=" md:hidden" @click="hidecard3 == false ? hidecard3 = true : hidecard3 = false">
                                    <Icon name="ic:baseline-keyboard-arrow-down" size="1.4em"></Icon>
                                </button>
                            </div>
                            <div v-if="hidecard3"
...
const hidecard1 = ref(false)
const hidecard2 = ref(false)
...
const HandleModule = async (type) => {
    ...
    subtitle.value = type == 'Aanmelden' ?
        'Vul hieronder je gegevens in om een account aan te maken.' :
        'Vul hieronder je gebruikersnaam en wachtwoord in om toegang te krijgen tot je account.'
