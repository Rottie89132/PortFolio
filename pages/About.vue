						...
						<div class="-mb-3 select-none xl:-mb-2 hidden md:flex items-center justify-between">
							...
							<div class="flex gap-x-4 -mt-6">
								<a href="https://www.linkedin.com/in/roland-meijer-07bb97198/" target="_blank"
									class="flex items-center justify-center px-4 py-2 font-semibold dark:text-neutral-800 dark:hover:bg-gray-100 dark:hover:ring-gray-100 dark:bg-white dark:ring-white text-sm text-white bg-neutral-800 hover:bg-neutral-900 ring-2 hover:ring-neutral-900 ring-neutral-800 rounded-md">
									<Icon class="-mt-1 mr-1" name="ri:external-link-line" size="1.2em" />Linkedin
								</a>
								<a :href="datalink" download
									class="flex items-center justify-center p-2 font-semibold dark:text-neutral-800 dark:hover:bg-gray-100 dark:hover:ring-gray-100 dark:bg-white dark:ring-white text-sm text-white bg-neutral-800 hover:bg-neutral-900 ring-2 hover:ring-neutral-900 ring-neutral-800 rounded-md">
