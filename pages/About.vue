		...
		<div :class="!Installed ? 'h-full' : 'h-[95%]'" class="w-full md:h-full p-5 pb-4 md:rounded-none rounded-3xl md:pl-52 bg-[#f0f0f0] md:bg-white dark:bg-[#131313] dark:md:bg-neutral-900 overflow-auto md:overflow-hidden">
			...
			<div class="w-full h-fit mt-6 md:my-10 xl:mt-20 md:w-[89.2%]">
				...
				<div v-if="data?.statusCode != 401 && data?.statusCode != 428 && !error">
					...
					<div v-auto-animate :class="!hidecard1 ? 'h-[27.7vh] md:h-[31vh] xl:h-[29.5vh]' : 'h-fit'" class="p-2 bg-[#F7F7F7] dark:bg-[#111111] rounded-lg md:mt-5 mt-7 overflow-auto">
						<div class="flex select-none items-center justify-between">
						...
						<div v-if="!hidecard1" class="grid gap-2 mt-2 h-[84%] overflow-auto snap-y snap-proximity scroll-smooth">
					...
					<div class="md:grid grid-cols-2 gap-4 md:mt-2 select-text">
						<div v-auto-animate class="p-2 bg-[#F7F7F7] dark:bg-[#111111] rounded-lg mt-2 overflow-auto">
							...
							<div v-if="hidecard2" class="grid md:hidden grid-cols-3 grid-rows-2 gap-2 p-2 mt-2 bg-white dark:bg-neutral-900 rounded-lg">
								<div>
						...
						<div v-auto-animate class="p-2 bg-[#F7F7F7] dark:bg-[#111111] rounded-lg mt-2 overflow-auto">
							...
							<div v-if="hidecard3" class="flex md:hidden justify-between gap-3 p-2 md:pb-4 mt-2 text-xs bg-white dark:bg-neutral-900 rounded-lg">
								<div>
									<p>Vue.js</p>
									<p>Nuxt.js</p>
									<p>Express.js</p>
