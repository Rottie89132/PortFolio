				...
				<div class="w-full h-fit mt-6 md:my-10 xl:mt-20 md:w-[89.2%]">
					...
					<div class="flex items-center justify-between gap-8 mb-6 md:justify-normal">
						<div>
							...
							<p class="leading-[1.1em] dark:text-white text-sm">
								Er zijn <span class="font-black">{{ MonthlyVisted }}</span> bezoekers geweest deze maand
							</p>
						</div>
						<div>
							<p class="font-black dark:text-white">Berichten</p>
							<p class="leading-[1.1em] dark:text-white text-sm">
								Er zijn <span class="font-black">{{ MonthlyMessages }}</span> berichten verzonden deze maand
							</p>
						</div>
					</div>
