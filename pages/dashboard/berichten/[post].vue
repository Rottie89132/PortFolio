				...
				<div class="w-full h-fit mt-6 md:my-10 xl:mt-20 md:w-[98%] lg:w-[88%] xl:w-[89.2%]">
					<div
						...
						<div class="flex -mb-1 items-center gap-2">
							...
							<p class="select-text underline font-medium opacity-85 text-xs -mb-1">{{
								Berichten.Response.phone }}</p>
						</div>
						...
						<div class="grid grid-cols-[1fr,1fr,0.1fr] mt-1 mb-4 md:flex items-center gap-3">
							<button
								class="dark:bg-white bg-neutral-800 hover:bg-neutral-900 hover:ring-neutral-900 dark:hover:bg-gray-50 dark:hover:ring-gray-50 ring-2 dark:ring-white ring-neutral-800 text-white dark:text-neutral-900 text-sm md:text-base font-bold p-1 md:px-8 rounded-md mt-2"
								@click="OpenMail(true)">Beantwoorden</button>
							<button
								class="dark:text-neutral-300 text-sm md:text-base dark:bg-neutral-800 dark:ring-neutral-800 text-neutral-600 bg-gray-200 ring-2 ring-gray-200 font-bold p-1 md:px-8 rounded-md mt-2"
								@click="OpenMail(false)">Afwijzen</button>
							<div class="dark:text-neutral-300 text-sm md:text-base justify-center dark:bg-neutral-800 dark:ring-neutral-800 text-neutral-600 bg-gray-200 ring-2 ring-gray-200 font-bold p-1 md:p-[0.40em] md:px-[0.40em] rounded mt-2 flex items-center"
								@click="markMessage">
								<Icon
									:class="MarkedPostId ? ' dark:text-white text-black' : 'text-neutral-600 dark:text-neutral-300'"
									class=" "
									:name="MarkedPostId ? 'material-symbols:bookmark-added' : 'material-symbols:bookmark-add'"
									size="1.2em" />
							</div>
						</div>
						<div
							class="whitespace-pre-wrap scroll-smooth leading-[1.30em] break-words text-balance max-h-[64vh] w-full bg-white dark:bg-neutral-900 p-4 rounded-lg mt-2 dark:text-white">
