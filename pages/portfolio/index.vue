<template>
                    ...
                    <div class="grid gap-8 md:gap-4">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <button @click="HandleModule('Contact')"
                                class="px-6 py-3 dark:hover:text-white  dark:ring-white dark:hover:ring-white text-sm font-semibold dark:text-white text-neutral-800 hover:text-neutral-900 ring-2 ring-neutral-800 hover:ring-neutral-900 rounded-xl">
                                Contact
                            </button>
                        </div>
                    </div>
    ...
    <ModalBase v-model:type="datatype" v-model:texthead="title" v-model:textbase="subtitle" v-model:status="OpenModule"
...
const HandleModule = async (type) => {
    ...
    subtitle.value = type == 'Contact' ?
        'Vul hieronder je contact gegevens in en laat een bericht achter.' :
