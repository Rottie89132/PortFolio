		...
		<div class="fixed w-full h-full p-4 pb-5 md:pb-0 md:p-0">
			<div :class="!Installed ? 'h-full' : 'h-[95%]'"
				...
				<div class="w-full h-fit mt-6 md:my-10 xl:mt-20 md:w-[98%] lg:w-[88%] xl:w-[89.2%]">
					...
					<div
						class="whitespace-pre-wrap scroll-smooth leading-[1.30em] break-words text-balance max-h-[75vh] w-full bg-white dark:bg-neutral-900 p-4 rounded-lg mt-2 dark:text-white">
